      ...
      <div class="col q-mx-sm">
        <q-card>
          ...
          <q-card-section>
            <br>
            <img
              src="~assets/images/platforms/windows.png"
              class="platform"
            >
            <br>
            <q-btn
              class="full-width bg-primary text-white"
              @click="downloadElectron"
            >
              Télécharger
            </q-btn>
          </q-card-section>
      ...
      <div class="col q-mx-sm">
        <q-card>
          ...
          <q-card-section>
            <br>
            <img
              src="~assets/images/platforms/macos.png"
              class="platform"
            >
            <br>
            <q-btn class="full-width text-white bg-secondary">
              Télécharger
            </q-btn>
          </q-card-section>
          <q-card-section class="text-center">
      ...
      <div class="col q-mx-sm">
        <q-card>
          ...
          <q-card-section>
            <br>
            <img
              src="~assets/images/platforms/linux.png"
              class="platform"
            >
            <br>
            <q-btn class="full-width text-white bg-info">
              Télécharger
            </q-btn>
          </q-card-section>
          <q-card-section class="text-center">
      ...
      <div class="col q-mx-sm">
        <q-card>
          ...
          <q-card-section>
            <br>
            <img
              src="~assets/images/platforms/android.png"
              class="platform"
            >
            <br>
      ...
      <div class="col q-mx-sm">
        <q-card>
          ...
          <q-card-section>
            <br>
            <img
              src="~assets/images/platforms/ios.png"
              class="platform"
            >
            <br><br><br>
            <q-btn class="full-width text-white bg-secondary">
